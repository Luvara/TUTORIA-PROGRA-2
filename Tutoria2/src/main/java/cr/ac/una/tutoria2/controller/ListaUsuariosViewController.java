 ...
 */
public class ListaUsuariosViewController extends Controller implements Initializable {
    ...
    @FXML
    private TableColumn<Usuario, String> tbcSegApellido;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        listaUsuarios = (List<Usuario>) AppContext.getInstance().get("LISTAUSUARIOS");

        ObservableList<Usuario> listaUsuariosObservable = FXCollections.observableArrayList(listaUsuarios);
    ...
    public void anadirSlots() {
        ...
        tbcSegApellido.setCellValueFactory(cd -> {

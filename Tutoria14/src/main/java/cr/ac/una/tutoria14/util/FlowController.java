 ...
 */
package cr.ac.una.tutoria14.util;

import cr.ac.una.tutoria14.App;
import cr.ac.una.tutoria14.controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("view/PrincipalView2.fxml"), this.idioma)));
            this.mainStage.show();
